...
*/
pessoa.nomeCompleto(); // "Olá! Meu nome é Genivaldo Silva!"
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // "Olá, eu sou o Genivaldo Silva, tenho 29 anos, 1.75, meu peso é 90 e, só hoje, eu já caminhei 0 metros!"
```
